...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { author: @paper.author, description: @paper.description, search_lines_id: @paper.search_lines_id, title: @paper.title } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { author: @paper.author, description: @paper.description, search_lines_id: @paper.search_lines_id, title: @paper.title } }
